	...
	<body style="background-color:#000">
      ...
      <main style="margin-top:7rem">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <table class="table" style="background-color:transparent ; width:100%" id="memo"></table>
                </div>
                <div class="col-md-6">
                    <table class="table" style="background-color:transparent ; width:100%" id="memo2"></table>
                </div>
                <div class="col-md-6">
                    <table class="table" style="background-color:transparent ; width:100%" id="memo3"></table>
                </div>
                <div class="col-md-6">
                    <table class="table" style="background-color:transparent ; width:100%" id="memo4"></table>
                </div>
                <div class="col-md-6">
                    <table class="table" style="background-color:transparent ; width:100%" id="memo5"></table>
                </div>
                <div class="col-md-6">
                    <table class="table" style="background-color:transparent ; width:100%" id="memo6"></table>
                </div>
                <div class="col-md-6">
                    <table class="table" style="background-color:transparent ; width:100%" id="memo7"></table>
                </div>
                <div class="col-md-6">
                    <table class="table" style="background-color:transparent ; width:100%" id="memo8"></table>
                </div>
            </div>
        </div>
      </main>
